...
<div class="section-block">
	...
	?>
		<div id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" class="section-item">
			<? if ($arSection['UF_DETAIL_TEXT']) { ?>
				<div class="section-detail-text"><?= $arSection['UF_DETAIL_TEXT'] ?></div>
			<? } ?>
			<h3 class="section-item-title">
				<a href="<?= $arSection['SECTION_PAGE_URL']; ?>"><?= $arSection['NAME']; ?></a>
				<? if ($arParams["COUNT_ELEMENTS"] && $arSection['ELEMENT_CNT'] !== null) { ?> <span>(<? echo $arSection['ELEMENT_CNT']; ?>)</span><? } ?>
			</h3>
			<? if ($arSection["DESCRIPTION"]) { ?>
				<div>
					<p class="section-item-description"><?= $arSection["DESCRIPTION"] ?></p>
				</div>
			<? } ?>
		</div>
	<? } ?>
