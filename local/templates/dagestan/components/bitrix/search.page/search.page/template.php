...
<div class="search">
	<form class="search__form" action="" method="get">
		...
		<? else : ?>
			<input value="<?= $arResult["REQUEST"]["QUERY"] ?>" size="40" placeholder="Введите поисковую фразу" class="search__query" type="text" name="q" />
		<? endif; ?>

		<? /** выпадающий спсиок "где искать" */ ?>
		<?/*
		...
		*/ ?>
		...
		<input type="submit" value="<?= GetMessage("SEARCH_GO") ?>" class="button button--primary button--big" />
	...
	<? else : ?>
		<p class="search__result"><?= GetMessage("SEARCH_NOTHING_TO_FOUND"); ?></p>
	<? endif; ?>
</div>