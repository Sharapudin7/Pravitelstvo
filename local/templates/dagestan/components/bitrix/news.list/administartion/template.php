...
<h1 class="administartion__title"><?= $arItem["NAME"] ?></h1>
<? if ($arItem["PREVIEW_PICTURE"]["SRC"]) : ?>
	<div class="administartion__image">
		<img src="<?= $arItem["PREVIEW_PICTURE"]["SRC"] ?>" alt="<?= $arItem["PREVIEW_PICTURE"]["ALT"] ?>">
	</div>
<? else : ?>
	<div class="administartion__image" style="display:none;">
	</div>
<? endif; ?>
<? if ($arItem["DISPLAY_PROPERTIES"]['NAME']['VALUE']) : ?>
	<h3 class="administartion__name"><?= $arItem["DISPLAY_PROPERTIES"]['NAME']['VALUE']; ?></h3>
<? else : ?>
	<h3 class="administartion__name" style="display:none;"></h3>
<? endif; ?>
<p class="administartion__description"><?= $arItem["PREVIEW_TEXT"]; ?></p>