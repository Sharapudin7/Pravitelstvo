...
<div class="speech-attention-vote-block">
	<div class="decoration">
		<div class="decoration__color" style="background-color: #f5f6fb;"></div>
	</div>

	<div class="container">

		<div class="speech-attention-vote-block__body">
			<section class="speech">
				<img class="speech__photo" src="<?= $arItem["PREVIEW_PICTURE"]["SRC"] ?>">

				<div class="speech__detail">
					<h2 class="speech__title"><?= $arItem['NAME'] ?></h2>

					<div class="speech__quote">
						<p><span style="font-weight: 400;"><?= $arItem['PREVIEW_TEXT'] ?></span></p>
					</div>

					<div class="speech__footer">
						<div>
							<div class="speech__sign">
								<p><span style="font-size: 10pt;"><?= $arItem['DETAIL_TEXT'] ?></p>
							</div>
						</div>
						<div>
							<a class="speech__more" href="<?= $arItem['DISPLAY_PROPERTIES']['LINK']['VALUE'] ?>" target="_blank">
								<span>Подробнее</span>
